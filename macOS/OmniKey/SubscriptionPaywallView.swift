...
struct SubscriptionPaywallView: View {
    ...
    var body: some View {
        VStack(spacing: 24) {
            VStack(spacing: 8) {
                Text(manager.isSubscribed ? "Manage OmniKey Pro" : "Unlock OmniKey Pro")
                    .font(.system(size: 26, weight: .bold))

                if manager.isSubscribed {
                    Text("You're currently subscribed to OmniKey Pro. You can manage or cancel your subscription at any time.")
                        .font(.system(size: 13))
            ...
            if !manager.isSubscribed {
                ...
                VStack(spacing: 6) {
                    ...
                    Text("To cancel, use the button below to open the App Store subscriptions page.")
                        .font(.system(size: 11))
                        .foregroundColor(.secondary)
                        .multilineTextAlignment(.center)
                        .padding(.horizontal, 24)
            ...
            HStack(spacing: 12) {
                ...
                .accessibilityLabel("Close subscription window")
                ...
                if manager.isSubscribed {
                    ...
                    .controlSize(.large)
                    .accessibilityLabel("Manage or cancel OmniKey subscription")
                    .accessibilityHint("Opens the App Store subscriptions page where you can cancel your OmniKey subscription.")
                } else {
                    Button {
                        Task {
                            isPurchasing = true
